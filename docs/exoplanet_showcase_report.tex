...
\title{Exoplanet Parameter Estimation Showcase\\\large Reconstructing and Modernizing the Polygence Prototype}
...
project. The original Polygence archive contained a three-script prototype, four
...
The recovered Polygence folder contributed the following assets:
\begin{itemize}
...
\subsection{Recovered Polygence Data}

The archived real observations are now versioned under
\texttt{data/polygence/}. The stellar mass catalog is:
\begin{center}
\begin{tabular}{l l}
...
\subsection{Recovered Polygence \texttt{star0} Fit}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/polygence_star0_fit.png}
...
\begin{itemize}
    ...
    \item archived Polygence CSVs under \texttt{data/polygence/}
